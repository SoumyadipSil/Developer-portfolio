    ...
    <>
      ...
      >
              ...
              <Column fillWidth fitHeight center paddingTop="xl" gap="l">
                ...
                >
                  <SplitText
                    ...
                    textAlign="center"
                  >
                    Hello, I'm Soumyadip, I'm a developer and ECE grad based in Kolkata {" "}
        ...
        >
          ...
          >
            <Testimonial
              ...
              stars={5}
              quote=" Partnering with  was a game-changer. We were able to streamline our workflow and improve our product significantly."
              name="Pixse"
          ...
          >
            <Column fillWidth gap="32" vertical="center">
              ...
              >
                ...
                , a passionate full-stack developer and software engineer who loves coding and
                  ...
                  <CursorCard
                    ...
                    trigger={
                      <span>
                        {" "}
                        <a
                          href="https://github.com/SoumyadipSil"
                ...
                . And when I'm not coding you'll find me exploring nature
                or staring at my aquascape like Netflix °:•.🐠*.•🪸.•:°
              </Text>
            ...
            <Flex fillHeight vertical="start" className="about-me-image">
              <MinimalAboutCard
                src="/me.webp" // Replace with a professional photo of you
                alt="A photo of Soumyadip Sil"
              />
            </Flex>
          </Flex>
        </Flex>
        ...
        >
          <Column gap="40" fillWidth maxWidth={95}>
            ...
            <Column gap="20" fillWidth>
              {[
                {
                  logo: "https://kreafolk.com/cdn/shop/articles/ibm-logo-design-history-and-evolution-kreafolk_f6963bf2-5011-41cd-a198-3b9b4dcff48d.jpg?crop=center&height=1200&v=1717725060&width=1200",
                  name: "IBM Skillsbuild",
                  role: "Python Development Intern (Project-based)",
                  period: "2024",
                },
                {
                  logo: "/me.webp",
        ...
        >
          ...
          >
            <img
              src="https://i.redd.it/5x8yy9y990ue1.gif"
